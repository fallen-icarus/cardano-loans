# Revision history for cardano-loans (archived)

> This is the archived development history. For the current versioning, see
> [VERSIONS.md](VERSIONS.md) (on-chain protocol) and [CHANGELOG.md](CHANGELOG.md) (off-chain code).

## 3.0.0.0rc — [`archive/v3.0.0.0rc`](https://github.com/fallen-icarus/cardano-loans/releases/tag/archive/v3.0.0.0rc)
...
## 2.0.0.0rc — [`archive/v2.0.0.0rc`](https://github.com/fallen-icarus/cardano-loans/releases/tag/archive/v2.0.0.0rc)
...
## 1.0.0.1rc — [`archive/v1.0.0.1rc`](https://github.com/fallen-icarus/cardano-loans/releases/tag/archive/v1.0.0.1rc)
...
## 1.0.0.0rc — [`archive/v1.0.0.0rc`](https://github.com/fallen-icarus/cardano-loans/releases/tag/archive/v1.0.0.0rc)
...
## 1.0.0 (MVP) — [`archive/v1.0`](https://github.com/fallen-icarus/cardano-loans/releases/tag/archive/v1.0)
