...
module Test.ActiveUTxOs.AcceptOffer.Failures where
...
-- Beacon Failures
-------------------------------------------------
-- | When accepting a single offer, withdraw the negotiation beacons. All required inputs are 
-- present. The active beacons are still minted.
...
-- | When accepting a single offer, only burn the beacons attached to the Offer UTxO. All required
-- inputs are present. The active beacons are still minted.
...
-- | When accepting a single offer, only burn the beacons attached to the Ask UTxOs. All required
-- inputs are present. The active beacons are still minted.
...
-- | When accepting a single offer, only burn Offer beacons. The Ask input is not present.
-- The active beacons are still minted.
...
-- | When accepting a single offer, only burn Ask beacons. The Offer input is not present. The
-- active beacons are still minted.
...
-- | Mint active beacons without including any negotiation loan inputs.
...
-- | Mint unrelated active tokens in addition to the required ones. All required inputs are
-- present.
...
-- | When accepting a single loan offer, mint an additional LoanId and store it with the
-- collateral UTxO. All required inputs are present.
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  ...
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 2
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
              , outputReferenceScript = toReferenceScript Nothing
...
-- | When accepting a single loan offer, mint an additional LoanId and store it with the lender
-- output. All required inputs are present.
...
-- | When accepting a single loan offer, mint an additional Active beacon and store it with the
-- collateral UTxO. All required inputs are present.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              { outputAddress = loanAddress
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Active" 2
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
...
-- | When accepting a single loan offer, mint an additional BorrowerId and store it with the
-- collateral UTxO. All required inputs are present.
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Active" 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 2
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
...
-- | When accepting a single loan offer, mint an additional Asset beacon and store it with the
-- collateral UTxO. All required inputs are present.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Active" 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 2
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
...
-- | When accepting a single loan offer, mint the wrong LoanId. All required inputs are present.
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  ...
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol "loanIdBeacon" 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
              , outputReferenceScript = toReferenceScript Nothing
...
-- | When accepting a single loan offer, mint the wrong BorrowerId. All required inputs are present.
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Active" 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol ("borrower") 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
...
-- | When accepting a single loan offer, mint the wrong Asset beacon. All required inputs are present.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Active" 1
                  , PV2.singleton activeBeaconCurrencySymbol "loanBeacon" 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
...
-- | When accepting a single loan offer, mint the wrong Active beacon. All required inputs are present.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              { outputAddress = loanAddress
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol "Act" 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 10
...
-- | When accepting multiple offers, only burn some of the Ask beacons.
...
-- | When accepting multiple offers, only burn some of the Offer beacons.
beaconFailure19 :: MonadEmulator m => m ()
beaconFailure19 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
...
-- | When accepting a single offer, do not store the newly minted Active beacons with the Active
-- datums.
beaconFailure20 :: MonadEmulator m => m ()
beaconFailure20 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  ...
                  , PV2.singleton activeBeaconCurrencySymbol (_unAssetBeacon loanBeacon) 0
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon1) 0
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 0
                  , uncurry PV2.singleton (_unAsset collateral1) 10
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
              , outputReferenceScript = toReferenceScript Nothing
...
-- Credential Failures
-------------------------------------------------
-- | When accepting a single loan offer, the new collateral UTxO is stored at the wrong loan
-- address.
...
-- | When accepting a single loan offer, there is an invalid Ask UTxO from a different borrower's
-- address. The invalid UTxO is spent with AcceptOffer redeemer.
...
credentialFailure2 = do
  let -- Borrower Info
      ...
      otherLoanAddr = toCardanoApiAddress $
        PV2.Address (PV2.ScriptCredential $ scriptHash loanScript) 
  ...
  -- Try to accept the offer.
  void $ transact borrowerPersonalAddr [otherLoanAddr,loanAddress,refScriptAddress] [borrowerPayPrivKey] $
    emptyTxParams
      { tokens = 
          [ TokenMint
              { mintTokens = 
...
-- | When accepting a single loan offer, there is an invalid Offer UTxO from a different borrower's
-- address. The invalid UTxO is spent with AcceptOffer redeemer.
...
-- | When accepting a single loan offer, there is an invalid Ask UTxO from a different borrower's
-- address. The invalid UTxO is spent with CloseOrUpdateAsk redeemer and the
-- CreateCloseOrUpdateAsk redeemer is used to burn the negotiation beacons. The other borrower's
-- credential is used for the CreateCloseOrUpdateAsk redeemer. The other borrower's credential
-- did not approve.
...
credentialFailure5 = do
  ...
  void $ transact 
    ...
    [otherLoanAddr,loanAddress,refScriptAddress] 
...
-- | When accepting a single loan offer, there is an invalid Offer UTxO from a different borrower's
-- address. The invalid UTxO is spent with CloseOrUpdateOffer redeemer and the CreateCloseOrUpdateOffer
-- redeemer is used to burn the negotiation beacons. The other borrower's credential is used in the
-- CreateCloseOrUpdateOffer redeemer. The other borrower's credential does not approve.
    ...
    emptyTxParams
      { tokens = 
          [ TokenMint
              ...
              , mintRedeemer = toRedeemer $ CreateCloseOrUpdateOffer borrowerCred2
              , mintPolicy = toVersionedMintingPolicy negotiationBeaconScript
              , mintReference = Just negotiationRef
              }
          , TokenMint
...
-- address. The invalid UTxO is spent with CloseOrUpdateOffer redeemer and the CreateCloseOrUpdateOffer
-- redeemer is used to burn the negotiation beacons. The other borrower's credential is used in the
-- CreateCloseOrUpdateOffer redeemer. The other borrower's credential does approve.
credentialFailure7 :: MonadEmulator m => m ()
credentialFailure7 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | When accepting multiple loan offers, an offer does not come from the borrower's address. The
-- offer is spent with AcceptOffer.
credentialFailure8 :: MonadEmulator m => m ()
credentialFailure8 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
  ...
  offerRefs <- map fst <$> 
    txOutRefsAndDatumsWithBeacon @OfferDatum (negotiationBeaconCurrencySymbol,"Offer")
...
-- | When accepting multiple loan offers, an offer does not come from the borrower's address. The
-- offer is spent with CloseOrUpdateOffer and the CreateCloseOrUpdateOffer redeemer with the other
-- lender's credential. The other lender does not approve.
credentialFailure9 :: MonadEmulator m => m ()
credentialFailure9 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | When accepting multiple loan offers, an offer does not come from the borrower's address. The
-- offer is spent with CloseOrUpdateOffer and the CreateCloseOrUpdateOffer redeemer with the other
-- lender's credential. The other lender does approve.
credentialFailure10 :: MonadEmulator m => m ()
credentialFailure10 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
  ...
  void $ transact 
    borrowerPersonalAddr 
    [otherLoanAddr,loanAddress,refScriptAddress] 
    [borrowerPayPrivKey,lenderPayPrivKey]
    emptyTxParams
      { tokens = 
          [ TokenMint
              { mintTokens = 
      ...
      , referenceInputs = [negotiationRef,activeRef,loanRef]
      , extraKeyWitnesses = [borrowerPubKey,lenderPubKey]
      , validityRange = ValidityRange
          { validityRangeLowerBound = Just startSlot
          , validityRangeUpperBound = Nothing
          }
...
-- | When accepting multiple loan offers, an ask does not come from the borrower's address. The
-- other Ask UTxO is spent with the AcceptOffer redeemer.
credentialFailure11 :: MonadEmulator m => m ()
credentialFailure11 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
  ...
  askRefs <- map fst <$> 
    txOutRefsAndDatumsWithBeacon @AskDatum (negotiationBeaconCurrencySymbol,"Ask")
...
-- | When accepting multiple loan offers, an ask does not come from the borrower's address. The
-- other Ask UTxO is spent with the CloseOrUpdateAsk redeemer and the CreateCloseOrUpdateAsk
-- redeemer with the other borrower's credential. The other borrower does not approve.
credentialFailure12 :: MonadEmulator m => m ()
credentialFailure12 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
  ...
  void $ transact borrowerPersonalAddr [otherLoanAddr,loanAddress,refScriptAddress] [borrowerPayPrivKey] $
    emptyTxParams
      ...
      , inputs = concat
          ...
          , [ Input 
                { inputId = head askRefs
                , inputWitness = 
                    SpendWithPlutusReference loanRef InlineDatum (toRedeemer AcceptOffer)
                }
            , Input 
                { inputId = head otherAskRefs
                , inputWitness = 
                    SpendWithPlutusReference loanRef InlineDatum (toRedeemer CloseOrUpdateAsk)
                }
            ]
...
-- | When accepting multiple loan offers, an ask does not come from the borrower's address. The
-- other Ask UTxO is spent with the CloseOrUpdateAsk redeemer and the CreateCloseOrUpdateAsk
-- redeemer with the other borrower's credential. The other borrower does approve.
credentialFailure13 :: MonadEmulator m => m ()
credentialFailure13 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- Approval Failures
-------------------------------------------------
-- | The proper borrower did not approve.
...
-------------------------------------------------
-- | Accept a single loan offer but do not leave any collateral.
...
-- | Accept a single loan offer using a single asset as collateral, but do not leave enough 
-- collateral.
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  ...
                  , PV2.singleton activeBeaconCurrencySymbol (_unBorrowerId borrowerBeacon) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1
                  , uncurry PV2.singleton (_unAsset collateral1) 9
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
              , outputReferenceScript = toReferenceScript Nothing
              }
...
-- | Accept a single loan offer using three assets as collateral, but do not leave enough
-- collateral.
collateralFailure3 :: MonadEmulator m => m ()
collateralFailure3 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
      borrowerPubKey1 = LA.unPaymentPubKeyHash $ Mock.paymentPubKeyHash borrowerWallet1
      ...
      , outputs =
          [ Output
              ...
              , outputValue = utxoValue 5_000_000 $ mconcat
                  ...
                  , uncurry PV2.singleton (_unAsset collateral3) 15
                  ]
              , outputDatum = OutputDatum $ toDatum activeDatum
              , outputReferenceScript = toReferenceScript Nothing
              }
...
-- | When accepting multiple offers, the first collateral output does not have enough collateral.
-- The offers use the same collateral.
collateralFailure4 :: MonadEmulator m => m ()
collateralFailure4 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | When accepting multiple offers, the second collateral output does not have enough collateral.
-- The offers use the same collateral.
collateralFailure5 :: MonadEmulator m => m ()
collateralFailure5 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | Accept multiple loan offers but do not create a collateral output for the first one.
collateralFailure6 :: MonadEmulator m => m ()
collateralFailure6 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | Accept multiple loan offers but do not create a collateral output for the second one.
collateralFailure7 :: MonadEmulator m => m ()
collateralFailure7 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output is missing the Active beacon.
collateralFailure8 :: MonadEmulator m => m ()
collateralFailure8 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output is missing the BorrowerId.
collateralFailure9 :: MonadEmulator m => m ()
collateralFailure9 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output is missing the AssetBeacon.
collateralFailure10 :: MonadEmulator m => m ()
collateralFailure10 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output is missing the LoanId.
collateralFailure11 :: MonadEmulator m => m ()
collateralFailure11 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output has two of the LoanIds.
collateralFailure12 :: MonadEmulator m => m ()
collateralFailure12 = do
  let -- Borrower Info
      borrowerWallet = Mock.knownMockWallet 1
      borrowerPersonalAddr = Mock.mockWalletAddress borrowerWallet
      borrowerPayPrivKey = Mock.paymentPrivateKey borrowerWallet
...
-- | The collateral output is locked at a different borrowers address.
collateralFailure13 :: MonadEmulator m => m ()
collateralFailure13 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
      borrowerPubKey1 = LA.unPaymentPubKeyHash $ Mock.paymentPubKeyHash borrowerWallet1
      ...
      loanAddress2 = toCardanoApiAddress $
        PV2.Address (PV2.ScriptCredential $ scriptHash loanScript) (Just $ PV2.StakingHash borrowerCred2)
...
-- | The collateral output is locked at a non-DApp address.
collateralFailure14 :: MonadEmulator m => m ()
collateralFailure14 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
      borrowerPubKey1 = LA.unPaymentPubKeyHash $ Mock.paymentPubKeyHash borrowerWallet1
...
-- Time Failures
-------------------------------------------------
-- | Accept a single loan offer with an expiration but do not specify invalid-hereafter.
...
timeFailure1 = do
  let -- Borrower Info
      ...
      offerDatum = unsafeCreateOfferDatum $ NewOfferInfo
        ...
        , _claimPeriod = 3600
        , _offerDeposit = 4_000_000
        , _offerExpiration = Just $ slotToPosixTime 10
        }
...
-- | Accept a single loan offer that has expired already.
...
timeFailure3 = do
  ...
  awaitTime $ fromJust $ offerDatum._offerExpiration
...
-- | Accept multiple loan offers where one of the offers has expired.
...
timeFailure4 = do
  ...
  awaitTime $ fromJust $ offerDatum1._offerExpiration
...
-------------------------------------------------
-- | When accepting multiple loan offers, the collateral outputs are not in the same order as the
-- offer inputs.
...
-- | When accepting multiple loan offers, the lender outputs are not in the same order as the 
-- offer inputs.
...
-------------------------------------------------
-- Lender Payment Failures
-------------------------------------------------
-- | The lender output did not go to the lender.
...
-- | The lender output is missing the required deposit.
...
-- | The lender output is missing the LoanId.
...
-- | The lender output has two LoanIds
...
-- | The lender output has the wrong LoanId in the datum.
...
-- | The lender output has the wrong policy id in the datum.
      ...
      , outputs =
          ...
          , Output
              ...
              , outputValue = utxoValue 4_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon) 1 ]
              , outputDatum = OutputDatum $ toDatum $ 
                  PaymentDatum ("",_unLoanId loanIdBeacon)
              , outputReferenceScript = toReferenceScript Nothing
              }
          ]
      , referenceInputs = [negotiationRef,activeRef,loanRef]
...
-- | When accepting loans from the same lender, the lender outputs are combined into a single
-- UTxO. The datum uses the first loan id.
paymentFailure7 :: MonadEmulator m => m ()
paymentFailure7 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
  ...
  void $ transact borrowerPersonalAddr1 [loanAddress1,refScriptAddress] [borrowerPayPrivKey1] $
    emptyTxParams
      ...
      , outputs =
          ...
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr1
              , outputValue = utxoValue 8_000_000 $ mconcat
                  [ PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon1) 1
                  , PV2.singleton activeBeaconCurrencySymbol (_unLoanId loanIdBeacon2) 1 
                  ]
              , outputDatum = OutputDatum $ toDatum $ 
...
-- | When accepting loans from the same lender, the lender outputs are combined into a single
-- UTxO. The datum uses the second loan id.
paymentFailure8 :: MonadEmulator m => m ()
paymentFailure8 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
...
-- | When accepting loans from the same lender, the loan id beacons are swapped in the outputs.
paymentFailure9 :: MonadEmulator m => m ()
paymentFailure9 = do
  let borrowerWallet1 = Mock.knownMockWallet 1
      borrowerPersonalAddr1 = Mock.mockWalletAddress borrowerWallet1
      borrowerPayPrivKey1 = Mock.paymentPrivateKey borrowerWallet1
...
-- | The collateral datum has the wrong active beacon policy id.
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_activeBeaconId = ActiveBeaconId ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong BorrowerId.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_borrowerId = BorrowerId ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_lenderAddress = PV2.Address borrowerCred Nothing}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanAsset = collateral1}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong loan asset beacon.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_assetBeacon = AssetBeacon ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanPrinciple = 0}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_compoundFrequency = Just 1}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_lastCompounding = 10000000000}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanTerm = 1}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanInterest = Fraction(0,10)}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong min payment.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_minPayment = 10}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_collateralization = Collateralization []}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong collateralIsSwappable.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_collateralIsSwappable = True}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong claim expiration.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_claimExpiration = 10}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanExpiration = 10}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong loan outstanding.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanOutstanding = Fraction (0,1)}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the wrong LoanId.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_loanId = LoanId ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the payment observer hash.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_paymentObserverHash = ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the interest observer hash.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_interestObserverHash = ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
...
-- | The collateral datum has the address update observer hash.
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_addressUpdateObserverHash = ""}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatumHash $ datumHash activeDatum
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_penalty = FixedFee 100}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr1
    ...
    emptyTxParams
      ...
      , outputs =
          [ Output
              ...
              , outputDatum = OutputDatum $ 
                  toDatum @ActiveDatum activeDatum{_totalEpochPayments = 100}
              , outputReferenceScript = toReferenceScript Nothing
              }
          , Output
              { outputAddress = toCardanoApiAddress lenderAddr1
...
-- TestTree
-------------------------------------------------
-- | A `TestTree` containing all failure scenarios for accepting Offer UTxOs.
tests :: [TestTree]
tests =
  [ -- Beacon Failures
  ...
  , scriptMustFailWithError "beaconFailure18" 
      "The wrong negotiation beacons were burned"
      beaconFailure18
  , scriptMustFailWithError "beaconFailure19" 
      "The wrong negotiation beacons were burned"
      beaconFailure19
  , scriptMustFailWithError "beaconFailure20" 
  ...
  , scriptMustFailWithError "credentialFailure6" 
      "Borrower did not approve"
      credentialFailure6
  , scriptMustFailWithError "credentialFailure7" 
      "Found loan input from different borrower"
      credentialFailure7
  , scriptMustFailWithError "credentialFailure8" 
      "Found loan input from different borrower"
      credentialFailure8
  , scriptMustFail "credentialFailure9" 
      -- Exact error depends on minting policy execution order.
      credentialFailure9
  , scriptMustFailWithError "credentialFailure10" 
      "Found loan input from different borrower"
      credentialFailure10
  , scriptMustFailWithError "credentialFailure11" 
      "Found loan input from different borrower"
      credentialFailure11
  , scriptMustFail "credentialFailure12" 
      -- Exact error depends on minting policy execution order.
      credentialFailure12
  , scriptMustFailWithError "credentialFailure13" 
      "Found loan input from different borrower"
      credentialFailure13
  ...
  , scriptMustFailWithError "collateralFailure2" 
      "Collateral output does not have enough collateral"
      collateralFailure2
  , scriptMustFailWithError "collateralFailure3" 
      "Collateral output does not have enough collateral"
      collateralFailure3
  , scriptMustFailWithError "collateralFailure4" 
      "Collateral output does not have enough collateral"
      collateralFailure4
  , scriptMustFailWithError "collateralFailure5" 
      "Collateral output does not have enough collateral"
      collateralFailure5
  , scriptMustFailWithError "collateralFailure6" 
      "Not all required outputs found"
      collateralFailure6
  , scriptMustFailWithError "collateralFailure7" 
      "Not all required outputs found"
      collateralFailure7
  , scriptMustFailWithError "collateralFailure8" 
      "UTxO does not have the right beacons"
      collateralFailure8
  , scriptMustFailWithError "collateralFailure9" 
      "UTxO does not have the right beacons"
      collateralFailure9
  , scriptMustFailWithError "collateralFailure10" 
      "UTxO does not have the right beacons"
      collateralFailure10
  , scriptMustFailWithError "collateralFailure11" 
      "UTxO does not have the right beacons"
      collateralFailure11
  , scriptMustFailWithError "collateralFailure12" 
      "UTxO has too many LoanIds"
      collateralFailure12
  , scriptMustFailWithError "collateralFailure13" 
      "Not all required outputs found"
      collateralFailure13
  , scriptMustFailWithError "collateralFailure14" 
      "Not all required outputs found"
      collateralFailure14
  ...
  , scriptMustFailWithError "paymentFailure3" 
      "Lender output can/must only contain ADA and the LoanId"
      paymentFailure3
  ...
  , scriptMustFailWithError "paymentFailure6" 
      "Not all required outputs found"
      paymentFailure6
  , scriptMustFailWithError "paymentFailure7" 
      "Lender output can/must only contain ADA and the LoanId"
      paymentFailure7
  , scriptMustFailWithError "paymentFailure8" 
      "Not all required outputs found"
      paymentFailure8
  , scriptMustFailWithError "paymentFailure9" 
      "Lender payment must have exactly one LoanId"
      paymentFailure9
