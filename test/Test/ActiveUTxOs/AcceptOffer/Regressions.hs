...
-- | Accept a single unsecured loan offer. The loan asset is ADA.
...
-- | Accept a single unsecured loan offer. The loan asset is a native asset.
...
-- | Accept a single loan offer with maxConsecutiveMisses set.
...
-- | Accept an offer without closing a corresponding ask.
...
-- | Accept an offer with a corresponding ask.
...
-- | Accept an offer with a corresponding ask. That Ask UTxO is not closed in this tx.
