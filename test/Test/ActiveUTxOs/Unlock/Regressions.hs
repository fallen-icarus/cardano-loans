...
-- Regression Tests
-------------------------------------------------
-- | Unlock a single finished Active UTxO. Invalid before is not specified.
...
-- | Unlock multiple finished Active UTxOs. Invalid before is not specified.
...
-- | Unlock a finished Active UTxOs, a lost Active UTxO, and and invalid Active UTxO in the
-- same transaction.
