...
The logic used is exactly the same as for closing and creating Offer UTxOs. Therefore, this
module only focuses on the use cases that are unique to updating Offer UTxOs.

-}
module Test.OfferUTxOs.UpdateOffer
  ( 
    -- * Scenarios Tested
...
tests :: TestTree
tests =
  testGroup "Update Offer(s) - Basic"
